...
const ColorBends = ({
  ...
  const autoRotateRef = useRef<number>(autoRotate ? 1 : 0)
  ...
  useEffect(() => {
    ...
    autoRotateRef.current = autoRotate ? 1 : 0
    ...
    material.uniforms.uNoise.value = noise ? 0.1 : 0
